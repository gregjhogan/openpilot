...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.CIVIC:
      ...
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 3840], [0, 3840]]  # TODO: determine if there is a dead zone at the top end
      tire_stiffness_factor = 0.677
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.7], [0.27]]
      ret.longitudinalTuning.kpBP = [0., 7., 35.]
      ret.longitudinalTuning.kpV = [1.5, 0.8, 0.5]
      ret.longitudinalTuning.kiBP = [0., 7., 35.]
      ret.longitudinalTuning.kiV = [0.21, 0.18, 0.15]
